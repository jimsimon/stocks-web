...
export class PositionsView extends LitElement {
        ...
        <table>
          <thead>
            <tr>
              ...
              <th class="number">Daily Chg</th>
              <th class="number">Daily Chg %</th>
              <th class="number">Total Chg</th>
              <th class="number">Total Chg %</th>
            </tr>
          </thead>
          <tbody>
  ...
  _fetchInstruments () {
    this.timeout = setTimeout(async () => {
      const instruments = this.positions.results.map(r => r.instrument)
